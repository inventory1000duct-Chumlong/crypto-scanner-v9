...
async function renderInstitutionalStatus(){
 ...
 `<div class="workspace-card"><h3>Build</h3><p>V20 Institutional<br>${esc(st.version||"20.0.0")}</p></div>`+
 '</div>';
}
