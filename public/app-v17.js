...
function renderAll(){renderSummary();renderPick();renderRows();renderWorkspace();renderWatchlist();renderAlerts();renderPlanner();renderPortfolioPL();renderJournal();renderCoach();renderExplain();renderRisk()}
...
function renderWorkspace(){
 ...
 box.innerHTML=
  ...
  `<div class="workspace-card"><h3>Alerts</h3><p>${hit} HIT / ${alerts.length} total</p></div>`+
